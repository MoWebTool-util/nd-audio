...
var tpl = require('./tpl/swf.handlebars');
 ...
 * @param params
 */
var AudioSwf = Base.extend({
  attrs: {
    swf: './audiojs.swf', // flash地址
    src: '', // 播放地址
    preload: true, // 预加载
    autoplay: true, // 自动播放
    loop: false // 自动循环
  ...
  initialize: function (config) {
    AudioSwf.superclass.initialize.call(this, config);
    var id = 'audio_' + (++_id);
